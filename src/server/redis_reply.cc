...
const std::map<Status::Code, std::string> redisErrorPrefixMapping = {
    ...
    {Status::RedisNoPerm, "NOPERM"},     {Status::RedisWrongType, "WRONGTYPE"},
    {Status::RedisReadOnly, "READONLY"}, {Status::RedisExecAbort, "EXECABORT"},
    {Status::RedisMoved, "MOVED"},       {Status::RedisCrossSlot, "CROSSSLOT"},
    {Status::RedisTryAgain, "TRYAGAIN"}, {Status::RedisClusterDown, "CLUSTERDOWN"},
    {Status::RedisNoGroup, "NOGROUP"},   {Status::RedisBusyGroup, "BUSYGROUP"}};
