...
func TestCommand(t *testing.T) {
	...
	t.Run("acquire GET command info by COMMAND INFO", func(t *testing.T) {
		...
		require.Empty(t, v[6].([]interface{}))
		require.Empty(t, v[7].([]interface{}))
		require.Empty(t, v[8].([]interface{}))
		require.Empty(t, v[9].([]interface{}))
	})
...
func TestCommandNamespaceSubcommands(t *testing.T) {
	...
	t.Run("COMMAND INFO can query namespace subcommand metadata", func(t *testing.T) {
		r := rdb.Do(ctx, "COMMAND", "INFO", "NAMESPACE", "NAMESPACE|ADD", "NAMESPACE|CURRENT")
		vs, err := r.Slice()
		require.NoError(t, err)
		require.Len(t, vs, 3)

		namespace := vs[0].([]interface{})
		require.Len(t, namespace, 10)
		require.Equal(t, "namespace", namespace[0])
		require.EqualValues(t, -2, namespace[1])
		require.Equal(t, []interface{}{"readonly", "admin", "skip-monitor"}, namespace[2])
		require.EqualValues(t, 0, namespace[3])
		require.EqualValues(t, 0, namespace[4])
		require.EqualValues(t, 0, namespace[5])
		require.Empty(t, namespace[6].([]interface{}))
		require.Empty(t, namespace[7].([]interface{}))
		require.Empty(t, namespace[8].([]interface{}))
		require.Len(t, namespace[9].([]interface{}), 5)

		add := vs[1].([]interface{})
		require.Len(t, add, 10)
		...
		require.Empty(t, add[6].([]interface{}))
		require.Empty(t, add[7].([]interface{}))
		require.Empty(t, add[8].([]interface{}))
		require.Empty(t, add[9].([]interface{}))

		current := vs[2].([]interface{})
		require.Len(t, current, 10)
		...
		require.Empty(t, current[6].([]interface{}))
		require.Empty(t, current[7].([]interface{}))
		require.Empty(t, current[8].([]interface{}))
		require.Empty(t, current[9].([]interface{}))
	})
